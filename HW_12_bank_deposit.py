class Bank:
    ...
    def register_client(self, client_id, name):
        if client_id not in self.clients:
            ...
            print(f'Клиент с данным id {client_id} уже зарегистрирован.')
    ...
    def calc_deposit_interest_rate(self, client_id):
        ...
        if client_id in self.deposits:
            ...
            print(f'У клиента {self.clients[client_id]} {client_id} отсутствуют открытые депозиты.')
        elif client_id not in self.clients:
            print(f'Клиент с данным id {client_id} не зарегистрирован.')
