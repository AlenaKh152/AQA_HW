...
print(validate_sequence())

# print(validate_sequence('4561261212345464'))  # == False
# print(validate_sequence('4561261212345467'))  # == True
# print(validate_sequence('378282246310005'))   # == True
